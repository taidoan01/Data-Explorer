...
def home_page():
    ...
    st.title("Welcome to the Data Explorer Interactive Web App!")

    st.markdown("""
        ### Your One-Stop Solution for Data Handling and Analysis

        **Data Explorer** simplifies the data analysis and machine learning process through a user-friendly 
    ...
    start_col1.markdown('<p style=" font-size: 22px; text-align: right;">To begin, click the button</p>',
                        unsafe_allow_html=True)

    start_button = start_col2.button(" Start ")
    if start_button:
