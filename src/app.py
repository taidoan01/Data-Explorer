...
from about import about_info
 ...
 # Page setup
st.set_page_config(
    page_title="Data Explorer Interactive Web Application",
    page_icon="📊",
    layout="wide",
)
# Header
side_bg_color = "#00B3CC"
side_text = "#333333"
st.markdown(
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #00B3CC;">
    <div class="navbar-brand" target="_blank">
        <span style="color: #333333; font-size: 44px;">  Data Explorer  </span>
    </div>
...
def main():
    ...
    with st.sidebar:
        ...
        st.sidebar.image("image/logo_image.png", width=300,use_column_width=True)
        # Option menu in sidebar
        pages = ["Home", "Chat with data", "Data Editor", "Profiling", "Visualization", "Feature Engineering", "Auto ML", "About"]
        nav_tab_op = option_menu(
            menu_title="Menu",
            options=pages,
            icons=['house', 'chat', 'pencil-square' ,'file-earmark-bar-graph', 'bar-chart-line', 'tools', 'robot', 'info-circle'],
            menu_icon="cast",
            default_index=0,
            styles={
